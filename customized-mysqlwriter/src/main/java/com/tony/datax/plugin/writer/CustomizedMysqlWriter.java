package com.tony.datax.plugin.writer;
...
import com.tony.datax.plugin.rdbms.writer.CustomizedRdbmsWriter;

import java.util.List;

public class CustomizedMysqlWriter extends Writer {
    private static final DataBaseType DATABASE_TYPE = DataBaseType.MySql;

    public static class Job extends Writer.Job {
        private Configuration originalConfig = null;
        private CustomizedRdbmsWriter.Job sinohealthCommonWriterJob;
        ...
        public void init() {
            ...
            this.sinohealthCommonWriterJob = new CustomizedRdbmsWriter.Job(DATABASE_TYPE);
    ...
    public static class Task extends Writer.Task {
        ...
        private CustomizedRdbmsWriter.Task sinohealthCommonWriterTask;

        @Override
        public void init() {
            this.writerSliceConfig = super.getPluginJobConf();
            this.sinohealthCommonWriterTask = new CustomizedRdbmsWriter.Task(DATABASE_TYPE);
