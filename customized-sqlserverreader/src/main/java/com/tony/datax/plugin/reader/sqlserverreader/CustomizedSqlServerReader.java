package com.tony.datax.plugin.reader.sqlserverreader;
...
public class CustomizedSqlServerReader extends Reader {
	...
	public static class Job extends Reader.Job {
		...
		public void init() {
			...
			this.commonRdbmsReaderJob = new CustomizedRdbmsReader.Job(
					DATABASE_TYPE);
	...
	public static class Task extends Reader.Task {
		...
		public void init() {
			...
			this.commonRdbmsReaderTask = new CustomizedRdbmsReader.Task(
