 ...
 * @date 2018/7/27
 **/
public class CustomizedRdbmsReader {
    ...
    public static class Task {
        ...
        protected String bizDataDbUrl;
        protected String bizDataDbUser;
        protected String bizDataDbPassword;
        ...
        public void init(Configuration readerSliceConfig) {
            ...
            this.bizDataDbUrl = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_URL);
            this.bizDataDbUser = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_USER);
            this.bizDataDbPassword = readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_PASSWORD);

            if (StrUtil.isBlank(bizDataDbUrl)) {
                this.bizDataDbUrl = jdbcUrl;
            }
            if (StrUtil.isBlank(bizDataDbUser)) {
                this.bizDataDbUser = username;
            }
            if (StrUtil.isBlank(bizDataDbPassword)) {
                this.bizDataDbPassword = password;
            }

            LOG.info("bizDataDbUrl:[{}]", bizDataDbUrl);
            LOG.info("bizDataDbUser:[{}]", bizDataDbUser);
            LOG.info("bizDataDbPassword:[{}]", bizDataDbPassword);

            try {
                LOG.info("sourceClass:[{}]", readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.SOURCE_CLASS));
                LOG.info("targetClass:[{}]", readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.TARGET_CLASS));
                LOG.info("processClass:[{}]", readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.PROCESSOR_CLASS));

                this.sourceClass = Class.forName(readerSliceConfig.getString("com.tony.datax.entity.source." + com.alibaba.datax.plugin.rdbms.util.Constant.SOURCE_CLASS));
                this.targetClass = Class.forName(readerSliceConfig.getString("com.tony.datax.entity.target." + com.alibaba.datax.plugin.rdbms.util.Constant.TARGET_CLASS));
                this.processor = (Processor) new DefaultObjectFactory().create(Class.forName("com.tony.datax.processors." + readerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.PROCESSOR_CLASS)));
