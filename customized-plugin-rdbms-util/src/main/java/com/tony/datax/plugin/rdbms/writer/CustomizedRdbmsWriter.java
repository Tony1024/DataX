package com.tony.datax.plugin.rdbms.writer;
...
import com.tony.datax.plugin.rdbms.init.BizDataIniter;
 ...
 * @date 2018/7/27
 **/
public class CustomizedRdbmsWriter {
    ...
    public static class Task {
        ...
        public void init(Configuration writerSliceConfig) {
            ...
            this.bizDataDbUrl = writerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_URL);
            this.bizDataDbUser = writerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_USER);
            this.bizDataDbPassword = writerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.BIZ_DATA_DB_PASSWORD);
            ...
            try {
                LOG.info("sourceClass:[{}]", writerSliceConfig.getString(com.alibaba.datax.plugin.rdbms.util.Constant.SOURCE_CLASS));
            ...
            try {
                ...
                while ((record = recordReceiver.getFromReader()) != null) {
                    ...
                    if (writeBuffer.size() >= batchSize || bufferBytes >= batchByteSize) {
                        doBatchInsert(connection, writeBuffer, source, target, processor);
                        writeBuffer.clear();
                        bufferBytes = 0;
                    }
                }
        ...
        protected void doBatchInsert(Connection connection, List<Record> buffer, Class source, Class target, Processor processor)
                throws SQLException {
            long begin = System.currentTimeMillis();
            ...
            try {
                ...
                connection.commit();
                long end = System.currentTimeMillis();
                LOG.info("BufferSize is [{}], Invoke time:[{}] ms", buffer.size(), end - begin);
        ...
        private PreparedStatement fillPreparedStatementColumn(PreparedStatement preparedStatement, Object targetEntity) {
